  ...
  const resultadoIMC = () => {
    try {
      ...
      if (isNaN(pesoNumber) || isNaN(alturaNumber) || pesoNumber < 0 || alturaNumber < 0) {
        throw new Error("!Numeros Incorretos!");
      }

      if (pesoNumber < 2 || pesoNumber > 500) {
        throw new Error("!Peso muito baixo ou muito alto, verifique novamente!");
      }

      if (alturaNumber < 0.5 || alturaNumber > 2.5) {
        throw new Error("!Altura muito baixa ou muito alta, verifique novamente!");
      }
